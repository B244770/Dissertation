...
# 举例：为Geno1在Env1种植，重复3次
design_matrix["Geno1", "Env1"] <- 1
rep_matrix["Geno1", "Env1"] <- 3

# 为Geno200在Env5种植，重复1次
design_matrix["Geno200", "Env5"] <- 1
rep_matrix["Geno200", "Env5"] <- 1
